...
eval("// 批量引入data目录下的js文件 并导出\nconst modulesFiles = __webpack_require__(\"./tools sync recursive \\\\.js$\")\nconst modules = modulesFiles.keys().reduce((modules, modulePath) => {\n  const value = modulesFiles(modulePath)\n  return { ...modules, ...value }\n}, {})\n\nmodule.exports = modules\n\n\n\n//# sourceURL=webpack://xj-tools/./index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getCookie\": () => (/* binding */ getCookie),\n/* harmony export */   \"setCookie\": () => (/* binding */ setCookie),\n/* harmony export */   \"removeCookie\": () => (/* binding */ removeCookie)\n/* harmony export */ });\n/* harmony import */ var js_cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/dist/js.cookie.mjs\");\n\n\nconst getCookie = (TokenName, option = {}) => {\n  return js_cookie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].get(TokenName, { ...option });\n};\n\nconst setCookie = (TokenName, token, option = {}) => {\n  js_cookie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].set(TokenName, token, { expires: 1, ...option });\n};\n\nconst removeCookie = (TokenName, option = {}) => {\n  js_cookie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].remove(TokenName, { ...option });\n};\n\n\n//# sourceURL=webpack://xj-tools/./tools/cookie.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"copyToClip\": () => (/* binding */ copyToClip)\n/* harmony export */ });\n\n// 单击复制\nconst copyToClip = (content, callback = () => { }) => {\n  var aux = document.createElement('input')\n  aux.setAttribute('value', content)\n  document.body.appendChild(aux)\n  aux.select()\n  document.execCommand('copy')\n  document.body.removeChild(aux)\n  callback()\n}\n\n//# sourceURL=webpack://xj-tools/./tools/copy.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"dateFormat\": () => (/* binding */ dateFormat),\n/* harmony export */   \"passTime\": () => (/* binding */ passTime),\n/* harmony export */   \"remainTime\": () => (/* binding */ remainTime)\n/* harmony export */ });\n/* harmony import */ var _stringNumber__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stringNumber */ \"./tools/stringNumber.js\");\n\n/**\n * 时间格式转换\n * @param {Number,'[object Date]'} time 时间戳或者时间对象 或者时间格式的字符串\n * @param {String} fmt 'YY-MM-DD hh:mm:ss'\n * @returns\n */\n\nconst dateFormat = (time, fmt = \"YY-MM-DD hh:mm:ss\") => {\n  const date =\n    Object.prototype.toString.call(new Date(time)) === \"[object Date]\"\n      ? new Date(time)\n      : new Date();\n\n  const year = date.getFullYear();\n  const month = date.getMonth() + 1;\n  const day = date.getDate();\n  const hour = date.getHours();\n  const min = date.getMinutes();\n  const second = date.getSeconds();\n\n  const newTime = fmt\n    .replace(/YY/g, year)\n    .replace(/Y/g, String(year).substr(2))\n    .replace(/MM/g, (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(month))\n    .replace(/M/g, month)\n    .replace(/DD/g, (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(day))\n    .replace(/D/g, day)\n    .replace(/hh/g, (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(hour))\n    .replace(/h/g, hour)\n    .replace(/mm/g, (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(min))\n    .replace(/m/g, min)\n    .replace(/ss/g, (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(second))\n    .replace(/s/g, second);\n\n  return newTime;\n};\n\nconst passTime = (fromTime) => {\n  var time = new Date().getTime() - fromTime;\n  var m = parseInt(time / 1000 / 60);\n  var h = parseInt(m / 60);\n  var d = parseInt(h / 24);\n  var month = parseInt(d / 30);\n  var y = parseInt(month / 12);\n  if (y) return y + \"年前\";\n  if (month) return month + \"个月前\";\n  if (d) return d + \"天前\";\n  if (h) return h + \"小时前\";\n  if (m) return m + \"分钟前\";\n  return y + \"刚刚\";\n};\n\nconst remainTime = (endTime) => {\n  var time = endTime - new Date().getTime();\n  var obj = { d: 0, h: 0, m: 0, s: 0 };\n  if (time > 0) {\n    obj.d = Math.floor(time / 1000 / 3600 / 24);\n    obj.h = Math.floor((time / 1000 / 3600) % 24);\n    obj.m = Math.floor((time / 1000 / 60) % 60);\n    obj.s = Math.floor((time / 1000) % 60);\n  }\n\n  for (const key in obj) {\n    if (Object.hasOwnProperty.call(obj, key)) {\n      const item = obj[key];\n      obj[key] = (0,_stringNumber__WEBPACK_IMPORTED_MODULE_0__.makeUp0)(item);\n    }\n  }\n\n  return obj;\n};\n\n\n//# sourceURL=webpack://xj-tools/./tools/dateTime.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"regular\": () => (/* binding */ regular)\n/* harmony export */ });\n/* harmony import */ var _message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./message */ \"./tools/message.js\");\n\n\nconst regular = {\n  // 数字\n  number: {\n    pattern: /^[0-9]+$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.number\n  },\n\n  // 正整数\n  positiveInteger: {\n    pattern: /^[1-9]\\d*$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.positiveInteger\n  },\n\n  // 正整数 1-5位\n  positiveIntegerLen1to5: {\n    pattern: /^[1-9]\\d{0,4}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.positiveIntegerLen1to5\n  },\n\n  // 876000内的正整数\n  positiveIntegerMaxHour: {\n    pattern: /^[1-9]$|^[1-9]\\d$|^876000$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.positiveIntegerMaxHour\n  },\n\n  // 非负整数\n  nonNegativeInteger: {\n    pattern: /^[1-9]\\d*$|0$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.nonNegativeInteger\n  },\n\n  // 正数\n  positiveNumber: {\n    pattern: /^[1-9]\\d*(\\.\\d*)?|0\\.\\d*[1-9]\\d*$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.positiveNumber\n  },\n\n  // 非负数\n  nonNegativeNumber: {\n    pattern: /^\\d+(\\.\\d+)?$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.nonNegativeNumber\n  },\n\n  // 手机号\n  phone: {\n    pattern: /^1[3456789]\\d{9}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.phone\n  },\n\n  // 邮箱\n  email: {\n    pattern: /^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.email\n  },\n\n  // code 1-32位\n  codeLen1to32: {\n    pattern: /^[a-zA-Z0-9_]{1,32}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.codeLen1to32\n  },\n\n  // 用户名 4-16位\n  usernameLen4to16: {\n    pattern: /^[a-zA-Z0-9]{4,16}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.usernameLen4to16\n  },\n\n  // 用户名 5-19位\n  usernameLen5to18: {\n    pattern: /^[a-zA-Z][a-zA-Z0-9_]{4,17}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.usernameLen5to18\n  },\n\n  // 密码 8-32位\n  passwordLen8to32: {\n    pattern: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d]{8,32}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.passwordLen8to32\n  },\n\n  // 密码 8-32位 含特殊符号\n  passwordLen8to32WithSymbol: {\n    pattern: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d!@#$%^&*(){}[\\]/?.>,<'\";:]{8,32}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.passwordLen8to32WithSymbol\n  },\n\n  // 密码 8-16位 含特殊符号\n  passwordLen8to16WithSymbol: {\n    pattern: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d!@#$%^&*(){}[\\]/?.>,<'\";:]{8,16}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.passwordLen8to16WithSymbol\n  },\n\n  // 身份证\n  idCard: {\n    pattern: /^[1-9]\\d{5}(?:18|19|20)\\d{2}(?:0[1-9]|10|11|12)(?:0[1-9]|[1-2]\\d|30|31)\\d{3}[\\dXx]$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.idCard\n  },\n\n  // 百分比 2位小数\n  percentage2Decimal: {\n    pattern: /^0$|^0\\.[1-9]$|^0\\.0[1-9]$|^0\\.[1-9]\\d$|^[1-9](\\.\\d{1,2})?$|^[1-9]\\d(\\.\\d{1,2})?$|^100$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.percentage2Decimal\n  },\n\n  // 百分比 1-100\n  percentagePositive: {\n    pattern: /^[1-9]$|^[1-9]\\d$|^100$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.percentagePositive\n  },\n\n  // 百分比 0-100\n  percentagePositiveN0: {\n    pattern: /^0$|^[1-9]$|^[1-9]\\d$|^100$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.percentagePositiveN0\n  },\n\n  // 保留一位小数\n  max1Decimal: {\n    pattern: /^\\d*(\\.\\d{1,1})?$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.max1Decimal\n  },\n\n  // 保留两位小数\n  max2Decimal: {\n    pattern: /^\\d*(\\.\\d{1,2})?$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.max2Decimal\n  },\n\n  // 最多 8位整数 2位小数\n  max8IntN2Decimal: {\n    pattern: /^[1-9]\\d{0,7}(\\.\\d{1,2})?$|^0(\\.\\d{1,2})?$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.max8IntN2Decimal\n  },\n\n  // 中文 数字 和 字母\n  chineseNumbersOrLetters: {\n    pattern: /^[\\u4e00-\\u9fa5a-zA-Z0-9]+$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.chineseNumbersOrLetters\n  },\n\n  // 邮编\n  postcode: {\n    pattern: /^(0[1-7]|1[0-356]|2[0-7]|3[0-6]|4[0-7]|5[1-7]|6[1-7]|7[0-5]|8[013-6])\\d{4}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.postcode\n  },\n\n  // 字母和数字\n  letterOrNumber: {\n    pattern: /^[A-Za-z0-9]+$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.letterOrNumber\n  },\n\n  // 例：172.16.168.138\n  ipv4: {\n    pattern: /^((25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.){3}(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.ipv4\n  },\n\n  // 例：172.16.168.138/24\n  ipv4Subnet: {\n    pattern: /^((25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.){3}(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\/([1-9]|([1-2][0-9])|(3[0-2]))$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.ipv4Subnet\n  },\n\n  // SSH秘钥名称\n  SSHSecretKeyLen2to64: {\n    pattern: /^[a-zA-Z][a-zA-Z0-9_-]{0,127}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.SSHSecretKeyLen2to64\n  },\n\n  // 网站地址\n  normalUrl: {\n    pattern: /^((https|http|ftp|rtsp|mms)?:\\/\\/)[^\\s]+/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.normalUrl\n  },\n\n  // 网站名称\n  netName: {\n    pattern: /^[a-zA-Z][a-zA-Z0-9_\"'-_\\(\\)\\[\\]\\.:^]{0,127}$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.netName\n  },\n\n  // CIDR验证规则\n  cidrCheck: {\n    pattern: /^(?:(?:[0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.){3}(?:[0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\/([1-9]|[1-2]\\d|3[0-2])$/,\n    message: _message__WEBPACK_IMPORTED_MODULE_0__.validateMsg.cidrCheck\n  }\n}\n\n\n//# sourceURL=webpack://xj-tools/./tools/regular.js?");
